export const teamMembers = [
  {
    ...
    status: "current",
    // Derived from explicit terms already used in this member's bio below
    // ("income tax and sales tax matters", "FBR and RTO proceedings", "tax
    // litigation"). Not independently verified — review before relying on it.
    practiceAreaSlugs: ["income-tax", "sales-tax", "fbr-matters", "tax-litigation"],
    metaDescription:
  ...
  },
  {
    ...
    status: "current",
    // Derived from this member's bio ("tax authorities... RTO Lahore and
    // FBR"; "corporate compliance, business structuring, partnership
    // matters"). Not independently verified — review before relying on it.
    practiceAreaSlugs: ["fbr-matters", "corporate-law-business-registrations"],
    metaDescription:
  ...
  },
  {
    ...
    status: "current",
    // Derived from this member's bio ("tax advisory, FBR proceedings,
    // income tax, sales tax... litigation support"). Not independently
    // verified — review before relying on it.
    practiceAreaSlugs: ["tax-advisory", "fbr-matters", "income-tax", "sales-tax", "tax-litigation"],
    metaDescription:
  ...
  },
  {
    ...
    status: "former",
    // Derived from this member's bio ("income tax, sales tax...") and
    // credentials ("FBR Liaison & Coordination Committee"). Not
    // independently verified — review before relying on it.
    practiceAreaSlugs: ["income-tax", "sales-tax", "fbr-matters"],
    metaDescription:
    ...
    bio: [
      "Khawaja Muhammad Asghar is a senior tax practitioner and Advocate High Court with decades of experience in taxation, corporate and commercial matters, civil law, and legal advisory. Throughout his distinguished career, he has developed extensive practical knowledge of tax law and administration, advising clients on complex taxation matters and representing their interests before relevant authorities and legal forums.",
      "A longstanding member of Lahore's legal and tax fraternity, he has held several prominent professional positions, including General Secretary of the Lahore Tax Bar Association, Executive Member of the Punjab Bar Council, and Member of the Lahore High Court Bar Association. He has also served as a Senior Member of the FBR Liaison & Coordination Committee, where he represented the professional interests of Lahore's tax practitioners and engaged with regional tax authorities on matters concerning the tax profession.",
      "His practice encompasses income tax, sales tax, tax assessments, appeals, tax administration, regulatory matters, corporate and commercial advisory, and civil legal matters. His extensive experience provides clients with a deep understanding of both the legal and practical dimensions of taxation and regulatory proceedings.",
      "With a career spanning decades, Khawaja Muhammad Asghar brings seasoned legal judgment, institutional knowledge, and extensive experience in taxation and commercial affairs. His longstanding contribution to the legal and tax profession reflects a commitment to professional service, sound legal counsel, and effective representation.",
    ],
  },
  {
    ...
    status: "former",
    // Derived from this member's bio ("taxation and income-tax law";
    // "banking and financial institutions"). Not independently verified —
    // review before relying on it.
    practiceAreaSlugs: ["income-tax", "banking-taxes"],
    metaDescription:
...
export function getTeamMembersByPracticeArea(practiceAreaSlug) {
  return teamMembers.filter((m) => m.practiceAreaSlugs?.includes(practiceAreaSlug));
}
